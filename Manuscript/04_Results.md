...
## 4.1 Results from Existing Studies

The published studies reviewed for this project suggest three main patterns. First, human
detection of AI-generated media remains unreliable even when participants know that some
materials may be synthetic. Frank et al. (2024) and Roca et al. (2025) both show that visual
detection is difficult across populations and image categories. This supports the assumption
that students' everyday visual judgement may not be enough to identify AI-generated images or
screenshot-like materials consistently.

Second, realistic AI-generated images can affect how credible people find online information.
Guo et al. (2025) found that AI-synthesized images can make false headlines more persuasive
when the images appear to provide strong visual evidence. This is important for the current
project because the survey does not only ask whether participants can classify images
correctly; it also asks how trustworthy each image would seem on social media.

Third, screenshot-like materials deserve special attention. Inwood and Zappavigna (2024)
argue that screenshots are often treated as visual evidence in online communication. For this
project, that means livestream interfaces, platform-style screenshots, and text-bearing visual
...
respondents reported heavy exposure to online media: 30 used social media for one to three
hours per day, 16 for three to five hours, and 16 for more than five hours. AI tool use was
also common, with 35 respondents reporting daily use, 21 reporting weekly use, and 10
reporting occasional use.

## 4.3 Source-Judgement Accuracy
...
## 4.4 Trust Ratings and Attitudes
...
## 4.5 Interpretation of Local Results
...
real visual materials.

The findings also complicate the role of screenshots. In this sample, livestream commerce
screenshots had relatively high source-judgement accuracy, but respondents still reported that
interface features can make images more believable. This means screenshot-like materials may
matter less because they are always harder to classify and more because they carry platform
context that can shape trust. Overall, the survey supports the paper's main argument: as
